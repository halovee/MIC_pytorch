...
from model.basesegmentor_wrappers import auto_fp16, force_fp32
from model.base_module import BaseModule
from model.tools import CrossEntropyLoss
from utils import wrap_resize
...
class BaseDecodeHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        self.loss_decode = CrossEntropyLoss(**loss_decode)
