...
from utils.evaluation.metric import eval_metrics
from utils.filesio.fileio import list_from_file
...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        # self.img_infos的部分在load_annotations中被赋值
    ...
    def load_annotations(self,
        ...
        print_log(f'Loaded {len(img_infos)} images from {img_dir}', logger=get_root_logger())
        return img_infos
