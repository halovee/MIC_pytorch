...
from utils.dist.distributed import MMDistributedDataParallel
from utils.dist.scatter_utils import scatter_kwargs
...
class DistributedDataParallelWrapper(nn.Module):
    ...
    def __init__(self,
        ...
        assert len(device_ids) == 1, (
            'Currently, DistributedDataParallelWrapper only supports one single CUDA device for each process.'
